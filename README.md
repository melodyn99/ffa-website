...
You can learn more about making AJAX requests from React components in [the HelpCenter entry on the React website](https://reactjs.org/docs/faq-ajax.html).
...
and [`navigateFallbackWishlist`](https://github.com/GoogleChrome/sw-precache#navigatefallbackwishlist-arrayregexp)
