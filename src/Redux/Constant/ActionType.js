...
const SET_RELATEDDATAID = 'SET_RELATEDDATAID';
// start from here
...
export {
    // auth
    GET_TOKEN, VERIFY_TOKEN, LOGIN_SUCCESS, LOGIN_FAILURE, LOGOUT, SET_RELATEDDATAID, GET_USER_INFO, REFRESH_TOKEN_BY_REFRESH_TOKEN,
    // GET_CONFERENCE_ID,
