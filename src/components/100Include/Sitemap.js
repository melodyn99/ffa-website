        ...
        <div className="wrapper-sitemap">
            <div className="sitemap clearfix">
                <ul>
                    ...
                    <li><Link to={'/' + i18n.language + '/school-course-material'}>Course Materials (done)</Link></li>
                    ...
                    <li><Link to={'/' + i18n.language + '/school-all-resource-management'}>Resource Management Course (done)</Link></li>
                    ...
                    <li><Link to={'/' + i18n.language + '/school-all-staff-account-management'}>Entrollment History (done)</Link></li>
                </ul>
