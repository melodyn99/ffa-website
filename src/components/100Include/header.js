            ...
            <div className="wrapper-header">
                <div className="header">
                    ...
                    <div className="desktop-menu clearfix">
                        ...
                        <li><Link to={"/" + i18n.language + "/student-management"} className={currentPath === 'student-management' ? 'active' : ''}>学生管理</Link></li>
                        ...
                        <li><Link to={"/" + i18n.language + "/my-alerts"} className={currentPath === 'my-alerts' ? 'active' : ''}>我的提醒 (3)</Link></li>
