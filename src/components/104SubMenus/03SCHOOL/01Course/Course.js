        ...
        return (
            <div className="subMenu">
                <ul className="clearfix">
                    ...
                    <li><Link to={"/" + i18n.language + "/course-student-management"} className={currentPath === 'all-courses' ? 'active' : ''}>学生管理</Link></li>
...
export default withTranslation()(connect(mapStateToProps)(CourseNotes));
