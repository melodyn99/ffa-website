...
class CoursePreparation extends Component {
        ...
        return (
            <div className="subMenu">
                <ul className="clearfix">
                    ...
                    <li><Link to={"/" + i18n.language + "/course-preparations"} className="active">预先准备</Link></li>
...
export default withTranslation()(connect(mapStateToProps)(CoursePreparation));
