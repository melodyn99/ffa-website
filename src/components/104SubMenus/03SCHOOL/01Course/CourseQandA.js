...
class CourseQandA extends Component {
        ...
        return (
            <div className="subMenu">
                <ul className="clearfix">
                    ...
                    <li><Link to={"/" + i18n.language + "/course-q-and-a"} className="active">课程问答</Link></li>
...
export default withTranslation()(connect(mapStateToProps)(CourseQandA));
