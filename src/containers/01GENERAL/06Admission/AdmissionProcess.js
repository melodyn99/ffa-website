            ...
            <div>
                <div className="wrapper-container-main">
                    <div className="container-main">
                        ...
                        <h2 className="pageTitle">入学申请流程</h2>
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(AdmissionProcess)));
