            ...
            <div>
                <div className="wrapper-container-main">
                    <div className="container-main">
                        ...
                        <h2 className="pageTitle">和学院合作的案例</h2>
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(SchoolCase)));
