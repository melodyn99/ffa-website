                    ...
                    <div className="container-main">
                        ...
                        <div className="wrapper-content">
                            ...
                            <div className="content">
                                <Link to={"/" + i18n.language + "/student-enrollment-history-cancelled"} className="dummy">Go to Cancelled Student Enrollment History cancelled</Link>
                                ...
                                <Grid container spacing={16} alignItems="center">
                                    ...
                                    <Grid item xs={11}>
                                        <div className="color-red">申请取消</div>
                                        2019 / 3 / 8 上午8:30
                                </Grid>
...
StudentEnrollmentHistoryCancelRequest.propTypes = {
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(withRouter(StudentEnrollmentHistoryCancelRequest))));
