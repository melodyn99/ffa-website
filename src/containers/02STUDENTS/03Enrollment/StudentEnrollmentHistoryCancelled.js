                    ...
                    <div className="container-main">
                        ...
                        <div className="wrapper-content">
                            ...
                            <Grid container spacing={16} alignItems="center">
                                ...
                                <Grid item xs={11}>
                                    <div className="color-red">取消完成</div>
                                    2019 / 3 / 10 上午8:30
                                </Grid>
...
StudentEnrollmentHistoryCancelled.propTypes = {
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(withRouter(StudentEnrollmentHistoryCancelled))));
