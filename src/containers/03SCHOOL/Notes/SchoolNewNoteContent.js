...
import { SchoolNewNoteContentStyles } from '../../../utils/01MaterialJsStyles/Notes/SchoolNewNoteContent';
...
class SchoolNewNoteContent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            activeTab: 'text',
    ...
    render() {
        ...
        if (this.state.formSubmitted) {
            return <Redirect push to={'/' + i18n.language + '/school-new-note-content'} />
        }
...
SchoolNewNoteContent.propTypes = {
...
const combinedStyles = combineStyles(CommonStyles, SchoolNewNoteContentStyles);

export default withTranslation()(autoScrollTop(connect(mapStateToProps, null)(withStyles(combinedStyles)(SchoolNewNoteContent))));
