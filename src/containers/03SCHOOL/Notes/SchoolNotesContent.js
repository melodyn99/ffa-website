...
import { SchoolNotesContentStyles } from '../../../utils/01MaterialJsStyles/Notes/SchoolNotesContent.js'
...
class SchoolNotesContent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            noteFile: [],
...
const combinedStyles = combineStyles(CommonStyles, SchoolNotesContentStyles);

export default withTranslation()(autoScrollTop(connect(mapStateToProps, null)(withStyles(combinedStyles)(SchoolNotesContent))));
