...
class SchoolNewNoteTitle extends Component {
    state = {
        title: '',
        content: '',
        formSubmitted: false,
...
const combinedStyles = combineStyles(CommonStyles, SchoolNewNoteTitleStyles);

export default withTranslation()(autoScrollTop(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(SchoolNewNoteTitle))));
