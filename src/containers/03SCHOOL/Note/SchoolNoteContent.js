...
import { SchoolNoteContentStyles } from '../../../utils/01MaterialJsStyles/Note/SchoolNoteContent.js'
...
class SchoolNoteContent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            noteFile: [],
...
const combinedStyles = combineStyles(CommonStyles, SchoolNoteContentStyles);

export default withTranslation()(autoScrollTop(connect(mapStateToProps, null)(withStyles(combinedStyles)(SchoolNoteContent))));
