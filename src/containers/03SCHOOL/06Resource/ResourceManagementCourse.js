...
import SubMenu from '../../../components/104SubMenus/03SCHOOL/06Resource/ResourceManagementCourse';
import EnhancedTableHead from '../../../components/103MaterialDesign/EnhancedTable/EnhancedTableHead';
import data from '../../../data/06Resource/ResourceManagementCourse';
...
class ResourceManagementCourse extends React.Component {
    state = {
        order: 'asc',
        orderBy: 'calories',
        selected: [],
...
ResourceManagementCourse.propTypes = {
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(ResourceManagementCourse)));
