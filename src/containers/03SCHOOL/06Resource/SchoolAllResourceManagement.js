...
class SchoolAllResourceManagement extends Component {
    constructor(props) {
        super(props);
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(withRouter(SchoolAllResourceManagement))));
