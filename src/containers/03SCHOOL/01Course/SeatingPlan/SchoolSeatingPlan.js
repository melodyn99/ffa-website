...
import { SeatingPlanStyles } from '../../../../utils/01MaterialJsStyles/SeatingPlan/SeatingPlan'
...
class SchoolSeatingPlan extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            companies: null
...
export default withTranslation()(autoScrollTop(connect(mapStateToProps, mapDispatchToProps)(withStyles(combinedStyles)(SchoolSeatingPlan))));
